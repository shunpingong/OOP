...
int main() {
    // Animal a("Testing", Black);
    // a.speak() ;

    // Mammal m("Mammal", Green); 
    // m.speak() ;

    // Dog d("Doggy",Black,"Jeff");
    // d.speak();
    // d.move();
    ...
    // Mammal *aniPtr = &dogi;                         //for 3.3 pointer doesn't create new object -> just pointing to same dog
    // Mammal &aniRef = dogi;                          //for 3.3 reference doesn't create new object
    // Mammal aniVal = dogi;                           //for 3.3 derived class sliecd to base case, create new object, cannot dynamic binding because not ref/ptr
